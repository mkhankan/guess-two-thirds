 ...
 * This class is made to deal with client without worrying if the server class was fully implemented or not
 */
public class ManualPlayer implements Runnable {
    ...
    public ManualPlayer(Socket clientSocket) {
        try {
